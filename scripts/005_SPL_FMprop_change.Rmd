...
SPL_1823 %>%
  select(subject_id, study_id, location_id, gender) %>%
...
FM_prop_locid %>%
  ...
  stat_summary(fun = mean, color = "black", geom = "point", shape = 20, size = 3) +
  coord_cartesian(ylim = c(0, 1)) +
  theme(legend.position = "none") +
  labs(x = "Year", y = "Proportion of women") +
  scale_x_discrete(labels = c("2018", "2023"))

ggsave(filename = "1823_F_prop_scatterconnect.png", path = here("Visualization"), bg="white", width = 7, height = 7)
...
FM_prop_locid %>%
  ...
  coord_cartesian(ylim = c(0, 1)) +
  theme(legend.position = "none") +
  labs(x = "Year", y = "Proportion of men") +
  scale_x_discrete(labels = c("2018", "2023"))

ggsave(filename = "1823_M_prop_scatterconnect.png", path = here("Visualization"), bg="white", width = 7, height = 7)
...
FM_prop_locid_change %>%
  ...
  ggplot(., aes(x = F_prop_2018, y = F_prop_2023, colour = location_id)) +
  geom_point() +
  geom_abline(slope = 1, linetype="dotted") +
  coord_cartesian(xlim = c(0, 1), ylim = c(0, 1)) +
  theme(legend.position = "none") +
  labs(x = "2018", y = "2023", title = "Proportion of women")

ggsave(filename = "1823_F_prop_scatter.png", path = here("Visualization"), bg="white", width = 7, height = 7)


## masc proportion
FM_prop_locid_change %>%
  filter(!is.na(M_prop_2318)) %>%
  ggplot(., aes(x = M_prop_2018, y = M_prop_2023, colour = location_id)) +
  geom_point() +
  geom_abline(slope = 1, linetype="dotted") +
  coord_cartesian(xlim = c(0, 1), ylim = c(0, 1)) +
  guides(colour = guide_legend(ncol = 2)) +
  theme(legend.position = "none") +
  labs(x = "2018", y = "2023", title = "Proportion of men")

ggsave(filename = "1823_M_prop_scatter.png", path = here("Visualization"), bg="white", width = 7, height = 7)
