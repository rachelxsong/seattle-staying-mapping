...
ggsave(filename = "2018_F_prop_map_dot.png", path = here("Visualization","gender"), bg="white", width = 7, height = 7)
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_M_prop_map_dot.png", path = here("Visualization","gender"), bg="white", width = 7, height = 7)
...
ggsave(filename = "2023_F_prop_map_dot.png", path = here("Visualization","gender"), bg="white", width = 7, height = 7)
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2023_M_prop_map_dot.png", path = here("Visualization","gender"), bg="white", width = 7, height = 7)
