...
ggsave(filename = "2018_raceRatio_Asian_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_raceRatio_Black_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_raceRatio_Latinx_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_raceRatio_Multi_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_raceRatio_NatAm_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
...
# Save Map_2018_dot in the Visualization folder ----
ggsave(filename = "2018_raceRatio_White_map_dot.png", path = here("Visualization/race"), bg="white", width = 7, height = 7)
```
